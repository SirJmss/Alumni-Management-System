  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _activeChapters       = (results[2]  as AggregateQuerySnapshot).count ?? 0;
  ...
  Widget _buildStatsGrid() {
    return GridView.count(
      ...
      children: [
        ...
        _statCard(Icons.apartment_outlined, 'Active Chapters',
            _activeChapters.toString(), 'Regional & batch groups',
            Colors.purple),
